...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - preparatime time required using 'PREPARATION_TIME'.

    Function that takes the number of layers in the lasagna and returns the preparation time required
